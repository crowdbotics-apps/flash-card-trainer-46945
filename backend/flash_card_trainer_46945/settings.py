"""
Django settings for flash_card_trainer_46945 project.
...
ROOT_URLCONF = 'flash_card_trainer_46945.urls'
...
WSGI_APPLICATION = 'flash_card_trainer_46945.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flash_card_trainer_46945 API",
    "DESCRIPTION": "API documentation for flash_card_trainer_46945 App",
    "VERSION": "v1",
}
